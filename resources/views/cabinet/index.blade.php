    ...
    <main class="main col-lg-9">
        ...
        @if($postsList->count())
            <div class="fast-links">
                ...
                <div class="fast-link-item ankets__item-moder" onclick="get_photo_modal(this)">Изменить главное фото на
                    анкетах
                </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-close-wrap">
                        <svg data-bs-dismiss="modal" aria-label="Close" width="34" height="34" viewBox="0 0 34 34"
                             fill="none"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body phone-modal-body">
                        <label for="avatar-all">
                            <div class="claim__modal">
                                <img src="/images/graphics/user-placeholder.png" alt="">
